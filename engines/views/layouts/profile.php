      ...
      <header class="header white-bg">
            ...
            <ul class="nav top-menu">
              ...
              <li id="header_inbox_bar" class="dropdown">
                  ...
                  <ul class="dropdown-menu extended inbox">
                      ...
                      <li>
                          <a href="#">
                              <span class="photo"><img alt="avatar" src="<?=base_url()?>pub/img/avatar-mini.jpg"></span>
                                    <span class="subject">
                      ...
                      <li>
                          <a href="#">
                              <span class="photo"><img alt="avatar" src="<?=base_url()?>pub/img/avatar-mini2.jpg"></span>
                                    <span class="subject">
                      ...
                      <li>
                          <a href="#">
                              <span class="photo"><img alt="avatar" src="<?=base_url()?>pub/img/avatar-mini3.jpg"></span>
                                    <span class="subject">
                      ...
                      <li>
                          <a href="#">
                              <span class="photo"><img alt="avatar" src="<?=base_url()?>pub/img/avatar-mini4.jpg"></span>
                                    <span class="subject">
          ...
          <div class="top-nav ">
              <ul class="nav pull-right top-menu">
                  ...
                  <li class="dropdown">
                      <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                          <img alt="" src="<?=base_url()?>pub/img/avatar1_small.jpg">
...
<div class="theme-config">
    <div class="theme-config-box show">
        ...
        <div class="skin-setttings">
            ...
            <div class="setings-item blue-skin">
                    <span class="skin-name ">
                        <a href="#performance" class="s-skin-1">
                            PERFORMANCE
                        </a>
                    </span>
            </div>
            <div class="setings-item yellow-skin">
                    <span class="skin-name ">
                        <a href="#requests" class="s-skin-3">
                            REQUESTS
                        </a>
                    </span>
            </div>
    ...
    <script class="include" type="text/javascript" src="<?=base_url()?>pub/js/jquery.dcjqaccordion.2.7.js"></script>
    ...
    <script src="<?=base_url()?>pub/js/slidebars.min.js" type="text/javascript"></script>
    <script src="<?=base_url()?>pub/assets/chart-master/Chart.js"></script>
    <script src="<?=base_url()?>pub/js/respond.min.js" ></script>
	...
	<script src="<?=base_url()?>pub/js/advanced-form-components.js"></script>
	<script src="<?=base_url()?>pub/js/core/profile.js"></script>
	<script src="<?=base_url()?>pub/js/all-chartjs.js"></script>
	<script>
        $(function(){
...
<!-- Mirrored from thevectorlab.net/flatlab/blank.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Jun 2015 14:33:52 GMT -->
</html>
