...
<head>
   ...
   <link href="<?=base_url()?>pub/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen"/>
</head>
<!-- END HEAD -->
<!-- BEGIN BODY -->
<body class="fixed-top">
        ...
        <div id="sidebar" class="nav-collapse collapse">
         ...
         <!-- BEGIN SIDEBAR MENU -->
          <ul class="sidebar-menu">
              <li class="sub-menu <?=$menuIndex[0]=="0"?"active":""?>">
              ...
              <li class="sub-menu">
                  ...
                  <ul class="sub">
                      <li><a href="<?=base_url()?>nursery">Nursery</a></li>
                      <li><a href="<?=base_url()?>nursery/nursery_groups">Nursery Groups</a></li>
                      <li><a href="<?=base_url()?>nursery/nursery_group_categories">Group Categories</a></li>
                      <li><a href="<?=base_url()?>nursery/nursery_settings">Settings</a></li>
                  </ul>
              </li>
              <li class="sub-menu">
                  <a class="" href="javascript:;">
   ...
   <script src="<?=base_url()?>pub/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.js" type="text/javascript"></script>
   <script src="<?=base_url()?>pub/js/jquery.sparkline.js" type="text/javascript"></script>
   ...
   <script src="<?=base_url()?>pub/js/easy-pie-chart.js"></script>
   <script src="<?=base_url()?>pub/js/sparkline-chart.js"></script>
   <script src="<?=base_url()?>pub/js/home-page-calender.js"></script>
   <script src="<?=base_url()?>pub/js/home-chartjs.js"></script>
