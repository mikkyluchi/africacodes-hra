...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="<?=base_url()?>pub/assets/chosen-bootstrap/chosen/chosen.css" />
    ...
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>pub/assets/bootstrap-timepicker/compiled/timepicker.css" />
   ...
   <link href="<?=base_url()?>pub/css/wotaman.css" rel="stylesheet" />
...
<ul id="float-icons" class="clearfix">
    <li><a href="#gp_mustards" class="op" id="icon6"><i class="icon-leaf" style="color:#FFF"></i></a></li>
    <li><a href="#gp_nursery" class="op" id="icon1"><i class="icon-group" style="color:#FFF"></i></a></li>
    <li><a href="#gp_routes_tasks" class="op" id="icon2"><i class="icon-road" style="color:#FFF"></i></a></li>
    <li><a href="#gp_expense_visits" class="op" id="icon3"><i class="icon-money" style="color:#FFF"></i></a></li>
    <li><a href="#gp_watermen" class="op" id="icon4"><i class="icon-filter" style="color:#FFF"></i></a></li>
    <li><a href="#gp_events" class="op" id="icon5"><i class="icon-calendar" style="color:#FFF"></i></a></li>
</ul>
...
<!--End Floating Sidebar-->
   ...
   <script type="text/javascript" src="<?=base_url()?>pub/assets/bootstrap-timepicker/js/bootstrap-timepicker.js"></script>
   ...
   <!--<script src="<?=base_url()?>pub/assets/jquery-character-counter-master/jquery.charactercounter.js"></script>-->
